...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 223, 273))
        ...
        self.verticalLayout_5.addWidget(self.checkBoxZeroZTrained)
        ...
        self.verticalLayout_5.addWidget(self.checkBoxGalTrained)
        ...
        self.verticalLayout_5.addWidget(self.checkBoxAgnosticZTrained)
        ...
        self.horizontalSliderSmooth.setProperty("value", 15)
        ...
        self.labelBestRelProb.setAlignment(QtCore.Qt.AlignCenter)
        self.labelBestRelProb.setObjectName("labelBestRelProb")
        self.horizontalLayout_11.addWidget(self.labelBestRelProb)
        self.labelReliableFlag = QtWidgets.QLabel(self.groupBox_3)
        font = QtGui.QFont()
        font.setItalic(True)
        self.labelReliableFlag.setFont(font)
        self.labelReliableFlag.setAlignment(QtCore.Qt.AlignCenter)
        self.labelReliableFlag.setObjectName("labelReliableFlag")
        self.horizontalLayout_11.addWidget(self.labelReliableFlag)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditMinWave.setText(_translate("MainWindow", "2500"))
        self.lineEditMaxWave.setText(_translate("MainWindow", "10000"))
        self.label_3.setText(_translate("MainWindow", "Smooth"))
        self.lineEditSmooth.setText(_translate("MainWindow", "15"))
        ...
        self.labelReliableFlag.setText(_translate("MainWindow", "Reliable?"))
