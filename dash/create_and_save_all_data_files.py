...
if __name__ == '__main__':
    ...
    trainingSetFilename = create_training_set_files(dataDirName, minZ=0., maxZ=0., numOfRedshifts=50, trainWithHost=True, classifyHost=False)
