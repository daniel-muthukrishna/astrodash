...
atels = [
    ...
    # ('Gemini/des16s2drt-20161128-gmos.flm', 0.338),
    ...
    # ('Keck/lrisDES16S2aif_obs2.spec.txt', 0.4),
    # ('Keck/lrisDES16X1kx.spec.txt', 0.546),
    # ('Keck/lrisDES16X3bji.spec.txt', 0.65),
    # ('MMT/DES16S2cpe-20161102.dat', 0.07),
    # ('MMT/DES16X1cph-20161102.dat', 0.49),
    # # ('MMT/DES16X2crr-20161102.dat', 0.),
    # # ('MMT/DES16X2crt-20161102.dat', 0.),
    # # ('MMT/DES16X2csj-20161102.dat', 0.),
    # # ('MMT/DES16X3crw-20161102.dat', 0.),
    # ('Magellan_Chile/DES16C1cbg.txt', 0.33),
    # # ('Magellan_Chile/DES16C1mm.txt', 0.),
    # ('Magellan_Chile/DES16C1mm_2.txt', 0.33),
    # # ('Magellan_Chile/DES16C3at.txt', 0.),
    # # ('Magellan_Chile/DES16E1bkp.txt', 0.),
    # # ('Magellan_Chile/DES16E1bkp_2.txt', 0.),
    # # ('Magellan_Chile/DES16E1bkp_3.txt', 0.),
    # # ('Magellan_Chile/DES16S1bzz.txt', 0.),
    # # ('Magellan_Chile/DES16S1bzz_2.txt', 0.),
    # # ('Magellan_Chile/DES16S1bzz_3.txt', 0.),
    # # ('Magellan_Chile/DES16S1bzz_4.txt', 0.),
    ...
    # ('VLT/DES16C1ccb_all.txt', 0.18),
    # # ('VLT/DES16C2aiy_all.txt', 0.),
