...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.scrollAreaWidgetContents_9.setGeometry(QtCore.QRect(0, 0, 202, 396))
        ...
        self.lineEditMaxAge = QtGui.QLineEdit(self.scrollAreaWidgetContents_9)
        self.lineEditMaxAge.setObjectName(_fromUtf8("lineEditMaxAge"))
        self.gridLayout_3.addWidget(self.lineEditMaxAge, 3, 1, 1, 1)
        ...
        self.lineEditMinAge = QtGui.QLineEdit(self.scrollAreaWidgetContents_9)
        self.lineEditMinAge.setObjectName(_fromUtf8("lineEditMinAge"))
        self.gridLayout_3.addWidget(self.lineEditMinAge, 2, 1, 1, 1)
        ...
        self.comboBoxSNType.addItem(_fromUtf8(""))
        self.comboBoxSNType.addItem(_fromUtf8(""))
        self.comboBoxSNType.addItem(_fromUtf8(""))
        self.comboBoxSNType.addItem(_fromUtf8(""))
        self.comboBoxSNType.addItem(_fromUtf8(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditMaxAge.setText(_translate("MainWindow", "50", None))
        ...
        self.lineEditMinAge.setText(_translate("MainWindow", "-20", None))
        ...
        self.comboBoxSNType.setItemText(0, _translate("MainWindow", "Ia-norm", None))
        self.comboBoxSNType.setItemText(1, _translate("MainWindow", "Ia-91T", None))
        self.comboBoxSNType.setItemText(2, _translate("MainWindow", "Ia-91bg", None))
        self.comboBoxSNType.setItemText(3, _translate("MainWindow", "Ia-csm", None))
        self.comboBoxSNType.setItemText(4, _translate("MainWindow", "Ia-02cx", None))
        self.comboBoxSNType.setItemText(5, _translate("MainWindow", "Ia-pec", None))
        self.comboBoxSNType.setItemText(6, _translate("MainWindow", "Ib-norm", None))
        self.comboBoxSNType.setItemText(7, _translate("MainWindow", "Ibn", None))
        self.comboBoxSNType.setItemText(8, _translate("MainWindow", "IIb", None))
        self.comboBoxSNType.setItemText(9, _translate("MainWindow", "Ib-pec", None))
        self.comboBoxSNType.setItemText(10, _translate("MainWindow", "Ic-norm", None))
        self.comboBoxSNType.setItemText(11, _translate("MainWindow", "Ic-broad", None))
        self.comboBoxSNType.setItemText(12, _translate("MainWindow", "Ic-pec", None))
        self.comboBoxSNType.setItemText(13, _translate("MainWindow", "IIP", None))
        self.comboBoxSNType.setItemText(14, _translate("MainWindow", "IIL", None))
        self.comboBoxSNType.setItemText(15, _translate("MainWindow", "IIn", None))
        self.comboBoxSNType.setItemText(16, _translate("MainWindow", "II-pec", None))
